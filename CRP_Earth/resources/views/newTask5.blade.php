...
<head>
  ...
  <link href="{{ URL::asset('/asset/css/newTask.css')}}" rel="stylesheet">
   </head>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/user">
        ...
        <div class="sidebar-brand-text mx-3">CSPEarth</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap"
          ...
          <i class="fa fa-tasks fa-window-maximize"></i>
          <span>Task</span>
        </a>
        <div id="collapseBootstrap" class="collapse show" aria-labelledby="headingBootstrap"
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item  active" href="/newTask">New Task</a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseForm" aria-expanded="true"
          ...
          <i class="fab fa-fw fa fa-user"></i>
          <span>Membership</span>
        </a>
        <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Member</h6>
            <a class="collapse-item" href="userSignUp">New membership</a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTable" aria-expanded="true"
          ...
          <i class="fas fa-fw fa fa-flag"></i>
          <span>Reports</span>
        </a>
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Report</h6>
            <a class="collapse-item" href="simple-tables.html">New Report</a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePage" aria-expanded="true"
          ...
          <i class="fab fa-fw fa fa-shopping-cart"></i>
          <span>Withdraw</span>
        </a>
        <div id="collapsePage" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Withdraw</h6>
            <a class="collapse-item" href="login.html">withdraw request</a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="charts.html">
          <i class="fab fa-fw fa fa-envelope-open"></i>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <img class="img-profile rounded-circle" src="{{ asset('/storage/images/'. $idcheck->image) }}" style="max-width: 60px">
                <span class="ml-2 d-none d-lg-inline text-white small">{{ $idcheck->name }}</span>
              </a>
...
if(seconds == 0)
{
  ...
  document.getElementById("jc").disabled=false;
                  ...
                  <div class="txt">
                    ...
                    <h1>To see <b>Next</b> image</h1>
                    <form action="/newTask6/{{ $idcheck->userid }}" action="get">
                    <div class="start-btn"><button id="jc" disabled>Finish</button></div>
                    </form>
                  </div>
         ...
         <div class="card front-face">
            <img src="{{ asset('/storage/images/'. $img_change) }}">
         </div>
         <div class="card back-face">
            ...
            <div class="info">
               ...
               <p>
                  After 10 sec you will get  <br>10 coins
               </p>
            </div>
            <ul>
        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>copyright &copy; <script> document.write(new Date().getFullYear()); </script> - developed by
              <b><a href="https://indrijunanda.gitlab.io/" target="_blank">jc</a></b>
            </span>
          </div>
        </div>
      </footer>
